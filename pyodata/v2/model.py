...
class Types:
    ...
    def _build_types():
        ...
        if Types.Types is None:
            ...
            Types.register_type(
                Typ('Edm.DateTimeOffset', 'datetimeoffset\'0000-00-00T00:00:00\'', EdmDateTimeOffsetTypTraits()))
...
def _milliseconds_since_epoch_to_datetime(value, tzinfo):
    try:
...
class EdmDateTimeTypTraits(EdmPrefixedTypTraits):
    ...
    def from_json(self, value):
        ...
        return _milliseconds_since_epoch_to_datetime(matches.group(1), current_timezone())
...
class EdmDateTimeOffsetTypTraits(EdmPrefixedTypTraits):
    """Emd.DateTimeOffset traits
       ...
       Literal forms:
       datetimeoffset'yyyy-mm-ddThh:mm[:ss]±ii:nn' (works only for all time zones)
       ...
       datetimeoffset is case-insensitive

       Example 1: datetimeoffset'1970-01-01T00:00:01+00:30'
        - /Date(1000+0030)/ (As DateTime, but with plus 30 minutes offset)
       Example 1: datetimeoffset'1970-01-01T00:00:01-00:30'
        - /Date(1000-0030)/ (As DateTime, but with minus 30 minutes offset)
       https://blogs.sap.com/2017/01/05/date-and-time-in-sap-gateway-foundation/
    """
    ...
    def to_json(self, value):
        ...
        return f'/Date({int(value.timestamp()) * 1000}{value.utcoffset(value):+})/'
    ...
    def from_json(self, value):
        ...
        # Might raise a PyODataModelError exception
        return _milliseconds_since_epoch_to_datetime(milliseconds_since_epoch, tzinfo)
    ...
    def from_literal(self, value):
        ...
        try:
            ...
            # Remaining cases should be parseable by fromisoformat()
